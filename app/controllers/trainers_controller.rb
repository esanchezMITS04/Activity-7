class TrainersController < ApplicationController
  ...
  def findtrainer
   @trainersearch = Trainer.where('lower(Full_Name) = ?', params[:search_trainer].downcase)
  end
  ...
  private
    ...
    def trainer_params
      params.require(:trainer).permit(:Full_Name, :Address, :Current_Weight_KG, :Height_CM, :Gender, :Email_Address)
    end
end
