...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { Address: @trainer.Address, Current_Weight_KG: @trainer.Current_Weight_KG, Email_Address: @trainer.Email_Address, Full_Name: @trainer.Full_Name, Gender: @trainer.Gender, Height_CM: @trainer.Height_CM } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { Address: @trainer.Address, Current_Weight_KG: @trainer.Current_Weight_KG, Email_Address: @trainer.Email_Address, Full_Name: @trainer.Full_Name, Gender: @trainer.Gender, Height_CM: @trainer.Height_CM } }
